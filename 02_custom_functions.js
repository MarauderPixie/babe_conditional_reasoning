...
*
*/
const group = _.sample(["simple", "additional"]); // You can determine global (random) parameters here
...
if (group == "simple") {
    qud_example = conditionals.simple;
  } else {
    qud_example = conditionals.additional;
  }
